...
class CclTestSpreadsheetBuilder
{
    /**
     * @param  list<list<string>>  $dataRows  Rows after header (each: id, nombre, 2do, apellido, edad, sexo, nivel, horario, status)
     */
    public function build(array $dataRows, string $path): void
    {
        $headers = ['ID N°', 'Nombre', '2do Nombre', 'Apellido', 'Edad', 'Sexo', 'Nivel', 'Horario', 'Status'];
        $allRows = [
            [],
            [],
            [],
